                                                    ...
                                                    <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                                                        ...
                                                        <div class="widget-todo-item-action d-flex align-items-center">
                                                            ...
                                                            <div class="avatar m-0 mr-50">
                                                                <img src="{{URL::asset('/admin/app-assets/images/profile/user-uploads/social-2.jpg')}}" alt="img placeholder" height="32" width="32">
                                                            </div>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer icon-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li class="widget-todo-item">
                                                    <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                                                        ...
                                                        <div class="widget-todo-item-action d-flex align-items-center">
                                                            ...
                                                            <div class="avatar m-0 mr-50">
                                                                <img src="{{URL::asset('/admin/app-assets/images/profile/user-uploads/user-05.jpg')}}" alt="img placeholder" height="32" width="32">
                                                            </div>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer icon-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <ul class="widget-timeline mb-0">
                                            <li class="timeline-items timeline-icon-primary active">
                                                ...
                                                <div class="timeline-content">
                                                    <img src="{{URL::asset('/admin/app-assets/images/icon/pdf.png')}}" alt="document" height="23" width="19" class="mr-50">New Order.pdf
                                                </div>
                                            </li>
                                            <li class="timeline-items timeline-icon-primary active">
                                                ...
                                                <div class="timeline-content">
                                                    <img src="{{URL::asset('/admin/app-assets/images/icon/pdf.png')}}" alt="document" height="23" width="19" class="mr-50">Invoices.pdf
                                                </div>
                                            </li>
                    ...
                    <div class="media m-75">
                        <a href="JavaScript:void(0);">
                            <div class="avatar mr-75">
                                <img src="{{URL::asset('/admin/app-assets/images/portrait/small/avatar-s-2.jpg')}}" alt="avtar images" width="32" height="32">
